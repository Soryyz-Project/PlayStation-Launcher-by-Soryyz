...
- **Геймпад** — полная поддержка DualSense, DualShock, Xbox и любых generic-геймпадов через Web Gamepad API с тактильной отдачей (вибрация)
- **Медиа-просмотрщик** — скриншоты и видео с превью, удалением, навигацией, поддержкой геймпада и вибрацией
...
Геймпад вибрирует при следующих действиях:
- **Навигация** — короткий импульс (50 мс, сила 1.0/0.8)
- **Подтверждение / Назад** — средний импульс (100 мс)
- **Удаление медиа** — двойной импульс
- **Открытие / закрытие медиа** — длинный импульс (150 мс)
